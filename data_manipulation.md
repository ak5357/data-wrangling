...
Use `select()` to select columns, or variables. Choose a dataframe to
select from and list the columns you want to see, it will show them to
you.
...
Use this to filter out rows conditionally based on some variables. It’s
case sensitive.
